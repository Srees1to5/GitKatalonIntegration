...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Username_username', [('variable') : 'Admin']), 'Admin')
...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/a_My Info'), 0)
