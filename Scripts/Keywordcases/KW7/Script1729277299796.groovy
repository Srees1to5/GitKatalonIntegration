...
CustomKeywords.'com.test.pack3.customfunction7.add'(546, 656)
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Comment_col-sm-4'))
