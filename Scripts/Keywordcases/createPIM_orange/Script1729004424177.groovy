...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_firstName'), 'sree')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_lastName'), 's')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Save'))

CustomKeywords.'com.test.pack1.customfunctionipm.createuser'()
