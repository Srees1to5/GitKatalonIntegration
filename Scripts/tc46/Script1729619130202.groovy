...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/a_EST-10'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_JPetStore Demo/font_Spotted Adult Female  Dalmation'), 
    0)
